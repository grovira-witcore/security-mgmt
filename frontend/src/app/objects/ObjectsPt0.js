...
import ObjectsPt0Action0Pt0 from './ObjectsPt0Action0Pt0.js';
import ObjectsPt0ContextualAction0Pt0 from './ObjectsPt0ContextualAction0Pt0.js';
import ObjectsPt0ContextualAction1Pt0 from './ObjectsPt0ContextualAction1Pt0.js';

const ObjectsPt0 = ReactRouterDOM.withRouter(function ({  }) {
  ...
  const handleContextualAction0 = async function (e, item) {
    ...
    const response = await fetch(`/api/object/${item.record.objectId}`, {
      method: 'get',
      headers: {
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${session.accessToken}`
    ...
    <div>
      <div>
        <div className="pb-1 d-flex align-items-center border-bottom">
          <Witcore.Title level={1} icon={IconObject} color="sky-blue" label={lang.objects} />
          <div className="ps-4">
            <Witcore.FiltersBar
              filters={[
                {
      ...
      {action && action.index === 0 ?
        ...
        >
          <ReactBootstrap.Modal.Header className="pt-2 pb-1 ps-2 pe-3" closeButton={true}>
            <Witcore.Title level={1} icon={IconAdd} color="sky-blue" label={lang.createObject} />
          </ReactBootstrap.Modal.Header>
          <ReactBootstrap.Modal.Body ref={bodyRefAction0} className="p-0">
            <div className="p-2">
              {actionData && <ObjectsPt0Action0Pt0 data={actionData} updateData={updateActionData} validated={actionValidated} />}
            </div>
      ...
      {contextualAction && contextualAction.index === 0 ?
        ...
        >
          <ReactBootstrap.Modal.Header className="pt-2 pb-1 ps-2 pe-3" closeButton={true}>
            <Witcore.Title level={1} icon={IconEdit} color="sky-blue" label={lang.updateObject} />
          </ReactBootstrap.Modal.Header>
          <ReactBootstrap.Modal.Body ref={bodyRefContextualAction0} className="p-0">
            <div className="p-2">
              {contextualActionData && <ObjectsPt0ContextualAction0Pt0 object={contextualAction ? contextualAction.object : null} data={contextualActionData} updateData={updateContextualActionData} validated={contextualActionValidated} />}
            </div>
          </ReactBootstrap.Modal.Body>
          <ReactBootstrap.Modal.Footer className="p-2">
            <div>
              <Witcore.Button label={lang.ok} color="blue" onClick={(e) => submitContextualAction0(e, contextualAction ? contextualAction.object.objectId : null)} />
            </div>
            <div>
      ...
      {contextualAction && contextualAction.index === 1 ?
        ...
        >
          <ReactBootstrap.Modal.Header className="pt-2 pb-1 ps-2 pe-3" closeButton={true}>
            <Witcore.Title level={1} icon={IconDelete} color="red" label={lang.deleteObject} />
          </ReactBootstrap.Modal.Header>
          <ReactBootstrap.Modal.Body ref={bodyRefContextualAction1} className="p-0">
            <div className="p-2">
              <ObjectsPt0ContextualAction1Pt0 object={contextualAction ? contextualAction.object : null} />
            </div>
          </ReactBootstrap.Modal.Body>
          <ReactBootstrap.Modal.Footer className="p-2">
            <div>
              <Witcore.Button label={lang.delete} color="red" onClick={(e) => submitContextualAction1(e, contextualAction ? contextualAction.object.objectId : null)} />
            </div>
            <div>
              <Witcore.Button label={lang.cancel} color="blue" onClick={(e) => cancelContextualAction(e)} />
            </div>
