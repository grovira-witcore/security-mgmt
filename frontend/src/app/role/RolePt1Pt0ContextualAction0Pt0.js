...
const RolePt1Pt0ContextualAction0Pt0 = ReactRouterDOM.withRouter(function ({ roleObject }) {
    ...
    <div>
      <div>
        <div className="py-4 px-2 fs-5">
          <Witcore.Paragraph
            template={lang.confirmDeleteRoleObject}
            alignment="justify-content-center"
            fields={[
              { type: 'string', style: function (value) { return 'fw-bold'; } },
            ]}
            data={[
              roleObject.objectName,
            ]}
          />
        </div>
      </div>
...
export default RolePt1Pt0ContextualAction0Pt0;
