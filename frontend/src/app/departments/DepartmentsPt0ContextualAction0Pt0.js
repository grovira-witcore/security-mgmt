...
const DepartmentsPt0ContextualAction0Pt0 = ReactRouterDOM.withRouter(function ({ department, data, updateData, validated }) {
...
export default DepartmentsPt0ContextualAction0Pt0;
