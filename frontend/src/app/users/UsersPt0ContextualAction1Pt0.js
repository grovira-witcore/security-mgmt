...
const UsersPt0ContextualAction1Pt0 = ReactRouterDOM.withRouter(function ({ user }) {
    ...
    <div>
      <div>
        <div className="py-4 px-2 fs-5">
          <Witcore.Paragraph
            template={lang.confirmDeleteUser}
            alignment="justify-content-center"
            fields={[
              { type: 'string', style: function (value) { return 'fw-bold'; } },
            ]}
            data={[
              Witcore.Utils.protect(function ([firstName, lastName]) { return `${firstName} ${lastName}` }, [ user.firstName, user.lastName ]),
            ]}
          />
        </div>
      </div>
...
export default UsersPt0ContextualAction1Pt0;
