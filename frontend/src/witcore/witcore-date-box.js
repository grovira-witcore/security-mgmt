  ...
  return (
    <div>
      <div className="px-1 pt-1 pb-2" data-invalid={errors.length > 0 ? '1' : null}>
        ...
        <input ref={inputRef} className={'form-control' + (validated && errors.length > 0 ? ' is-invalid' : '')} type="text" placeholder={placeholder} value={textValue ?? (value !== null && value !== undefined ? Witcore.Utils.formatDate(value, dateFormat) : '')} onClick={handleOnClick} onKeyPress={handleOnKeyPress} onChange={handleOnChange} onBlur={handleOnBlur} />
