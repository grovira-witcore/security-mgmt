...
Witcore.DatePicker = function ({ value, onChange }) {
  ...
  return (
    <div>
      <div className="p-1 pb-2 d-flex">
        <div className="text-blue cursor-pointer" onClick={handlePreviousMonthClick}><Witcore.Icon.ArrowLeft size="sm" /></div>
        <div className="flex-grow-1 pt-1 text-center fs-6 fw-bold">{getMonthText(calendarPointer.month) + ' ' + calendarPointer.year}</div>
        <div className="text-blue cursor-pointer" onClick={handleNextMonthClick}><Witcore.Icon.ArrowRight size="sm" /></div>
      </div>
