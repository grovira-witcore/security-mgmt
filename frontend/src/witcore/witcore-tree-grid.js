...
Witcore.TreeGrid = function ({ containerSize, levels, items }) {
              ...
              if (index === 0) {
                return (
                  <td key={'value-' + index} className={'d-flex align-middle text-start'}>
                    ...
                    {hasChildren ?
                      (expandedOrCollapsed === 'expanded' ? <Witcore.Icon.Expanded size="sm" /> : <Witcore.Icon.Collapsed size="sm" />) :
                      <div style={{ width: Witcore.Utils.convertSizeIcon('sm') }} />
                    }
                    <div className={'ps-1' + (Witcore.Utils.protect(field.color, value) ? ' text-' + Witcore.Utils.protect(field.color, value) : '')}>
                      ...
                      {dockedField && (
                        <div className="text-muted fw-light">
                          <Witcore.Field
                            ...
                            color={Witcore.Utils.protect(dockedField.color, dockedValue)}
                            style={Witcore.Utils.protect(dockedField.style, dockedValue)}
                          />
                        </div>
                      )}
                    </div>
